...
public class PanelWin2 : MonoBehaviour
{
    ...
    public void ShareMessenger()
    {
        ...
        gameContext.chooseAsync(p, () => { Debug.Log("Choose Done"); });
    }
    ...
    public void Invite()
    {
        ...
        Dictionary<string, object> p = new Dictionary<string, object>();
        p.Add("filters", new List<string>() { "NEW_CONTEXT_ONLY" });
        gameContext.chooseAsync(p, () => { Debug.Log("Reward"); });
    }

    public void InvitePlaying()
    {
        QMG.GameContext gameContext = new QMG.GameContext();
        gameContext.joinTournament();
    }
}
